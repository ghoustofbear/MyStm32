...
void ModBusTask(void const * argument)
{
  for(;;)
  {
    ...
    if (evt.status == osEventMessage)
      {
        uint8_t byte = (uint8_t) evt.value.vqeqeqeeace for incoming?
        if(mb_buf_in_count<254)
        {
          mb_buf_in[mb_buf_in_count]=byte;
          mb_buf_in_count=mb_buf_in_count+1; // prevent opt/war on come compilers
        }
        else // oops, bad frame, by standard we should drop it and no ans``````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````PPL[;REQQSAD``````````````````````````````````` ZSZAEDZXNNM``J`IOIOH`PO[P-[][]XXE``MMMMMMMMMM`MMMM`M``ssdsssss=ds'f;
